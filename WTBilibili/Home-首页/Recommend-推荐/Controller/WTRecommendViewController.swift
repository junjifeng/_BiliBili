...
class WTRecommendViewController: UITableViewController
{
    ...
    // MARK: 控件
    /// headerView
    private var headerView = WTBannerHeaderView()
...
extension WTRecommendViewController
{
    ...
    private func setupUI()
    {
        ...
        headerView.frame = CGRect(x: 0, y: 0, width: WTScreenWidth, height: bannerHeaderViewHeight)
...
extension WTRecommendViewController
{
    ...
    private func loadHeaderViewData()
    {
        NetworkTools.shareInstance.loadHomeRecommendBanner { (result, error) in
            ...
            {
                bannerItems.append(WTBannerItem(dict: itemDict))
            }
...
// MARK: - WTBannerHeaderViewDelegate
extension WTRecommendViewController: WTBannerHeaderViewDelegate
{
